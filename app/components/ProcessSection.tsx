...
export default function ProcessSection() {
  ...
  return (
    ...
    >
      {/* Near full-bleed card — small gutter so it almost touches the viewport */}
      <div className="w-full px-2 sm:px-3 md:px-4">
        <motion.div
          className="w-full rounded-2xl px-3 pb-5 pt-8 sm:rounded-3xl sm:px-4 sm:pb-6 sm:pt-10 md:px-5 md:pb-8 md:pt-12 lg:rounded-[1.75rem] lg:pb-9 lg:pl-4 lg:pr-8 lg:pt-14 xl:pl-5 xl:pr-12"
